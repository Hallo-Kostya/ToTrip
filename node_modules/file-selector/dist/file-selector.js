...
function fromDataTransferItem(item, entry) {
    ...
    if (typeof item.getAsFileSystemHandle === 'function') {
        return item.getAsFileSystemHandle()
            .then(function (h) { return __awaiter(_this, void 0, void 0, function () {
            var file;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        file = _a.sent();
                        file.handle = h;
                        return [2 /*return*/, (0, file_1.toFileWithPath)(file)];
                }
            });
        }); });
    }
    ...
    var fwp = (0, file_1.toFileWithPath)(file, (_a = entry === null || entry === void 0 ? void 0 : entry.fullPath) !== null && _a !== void 0 ? _a : undefined);
